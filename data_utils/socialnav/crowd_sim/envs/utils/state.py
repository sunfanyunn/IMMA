...
class ObservableState(object):
    def __init__(self, px, py, vx, vy, radius, belief=-1):
        self.px = px
        self.py = py
        self.vx = vx
        self.vy = vy
    ...
    def to_tuple(self):
        return self.px, self.py, self.vx, self.vy, self.radius, self.belief
...
def tensor_to_joint_state(state):
    ...
    robot_state = robot_state[0, -1, ...]
    human_states = human_states[0, -1, ...]
