...
from crowd_nav.policy.multistep_model_predictive_rl import MultistepModelPredictiveRL
...
# my new policy
policy_factory['multistep_model_predictive_rl'] = MultistepModelPredictiveRL
